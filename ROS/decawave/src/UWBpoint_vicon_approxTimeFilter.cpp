...
void publishCallback(const PointStamped::ConstPtr& uwb, const PoseStamped::ConstPtr& vicon)
{
...
int main(int argc, char *argv[])
{
    ...
    vicon_pub = nh.advertise<PoseStamped>("vicon2uwbPoint", 1);
    uwb_pub = nh.advertise<PointStamped>("uwbPoint2vicon", 1);
